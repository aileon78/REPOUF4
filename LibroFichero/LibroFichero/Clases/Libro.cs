...
namespace LibroFichero.Clases
{
    ...
    class Libro
    {
        ...
        public void escriuObjecteTextFitxer(Libro l)
        {
            String linia;
            linia = titulo + ";" + any + ";" + autor + ";" + color + ";" + contenido + ";" + dimensiones + ";" + numPag + "\n";

            l.escriuTextFitxer(linia);
        ...
        {
            //Hem d'importar : using System.IO;
            //utilizamos Stream para acceder al archivo
            StreamReader arxiu = new StreamReader(fitxer);

            //declaramos variable linia para ir guardando de linia en linia
            String linia; 

            //declaramos un vector de tamaño de las variables a guardar
